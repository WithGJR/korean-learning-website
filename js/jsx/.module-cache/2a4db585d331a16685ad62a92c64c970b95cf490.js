var Paragraph = React.createClass({displayName: "Paragraph",
    ...
    console.log(this.refs.paragraphContent.getDOMNode().parentNode());
  ...
  render: function() {
  	...
  	return (
        ...
        React.createElement("div", {className: "paragraph-content", ref: "content", dangerouslySetInnerHTML: {__html: rawMarkup}})
      )
  	);
  }
});
